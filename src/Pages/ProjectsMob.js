  ...
  return (
    <>
      <section id="ProjectSection" name="ProjectSection" className="sm:py-40">
        <div className="block sm:hidden mx-auto pt-5 absolute  opacity-40">
        ...
        <div>
          <div
            onClick={() => click(1)}
            className="card-text container max-w-sm mx-auto pt-20  cursor-pointer"
          >
            <Slide triggerOnce duration={500} direction="right">
              ...
              >
                <div
                  id="d1h1"
                  className=" bg-gray-100 h-full absolute  transition-all ease-in duration-1000 right-0.5 w-0 rounded-lg"
                ></div>
                ...
                <div className="card-text p-6">
                  ...
                  <div
                    id="line"
                    className="sm:w-36 bg-gray-100 absolute ml-24 mt-20 mr-72 h-1  transition-all ease-in duration-1000 right-0.5 translate w-0"
                  ></div>
                  <Slide triggerOnce duration={800} direction="right">
                    <div className="sm:pr-60 flex justify-center">
                      <div
                        id="d1h2"
                        className="bg-gray-100 h-16 absolute  transition-all ease-in duration-1000 right-0.5 translate w-0"
                      ></div>
                      <p className="sm:pr-40 flex justify-center text-white text-2xl font-bold dark:text-white">
                        GBSHSE Website
                      </p>
                    </div>
                  </Slide>
          ...
          <div
            onClick={() => click(2)}
            className="max-w-sm mx-auto card-text container mt-10 sm:mt-32 cursor-pointer transition ease-in duration-700"
          >
            <Slide triggerOnce duration={500} direction="left">
              ...
              >
                ...
                <div className="card-text p-6">
                  <div
                    id="line"
                    className="sm:w-36 bg-gray-100 mt-36 mr-96 h-1 absolute  transition-all ease-in duration-1000 right-8 translate w-0"
                  ></div>

                  <Slide triggerOnce duration={800} direction="left">
                    <div
                      id="title1"
                      className="sm:pr-64 flex justify-center right-8"
                    >
                      <div
                        id="d2h2"
                        className={`bg-gray-100 mr-96 h-32 absolute transition-all ease-in duration-1000 w-0 right-8 shadow-2xl`}
                      ></div>
                      <p className="sm:pr-64 flex justify-center text-white text-2xl  font-bold dark:text-white">
          ...
          <div
            onClick={() => click(4)}
            className={`card-text container mx-auto max-w-sm pt-10 cursor-pointer transition-opacity ease-in duration-700 `}
          >
            <Slide triggerOnce duration={500} direction="right">
              <Tilt
                scale={1.2}
                transitionSpeed={2500}
                className="card4 mx-auto h-full w-64 card-text bg-no-repeat bg-cover block shadow-2xl rounded-lg"
              >
                <div
                  id="d4h1"
                  className="mb-40 bg-gray-100 h-full fixed transition-all ease-in duration-1000 right-0.5 w-0 rounded-lg"
                ></div>
                <div className="sm:mr-40 card-text p-6">
                  <div id="title2" className="mt-72 flex justify-center">
                    ...
                    ></div>
                    <Slide triggerOnce duration={800} direction="right">
                      <p className="sm:pr-28 flex justify-center text-white text-2xl font-bold dark:text-white">
                        GameStop
                      </p>
                    </Slide>
                    <div
                      id="line"
                      className="bg-gray-100 mt-12 h-1 absolute transition-all ease-in duration-1000 sm:right-0.5 translate w-40"
                    ></div>
                  </div>
                </div>
                <p
          ...
          <div
            onClick={() => click(3)}
            className="card-text container max-w-sm mx-auto pt-10 cursor-pointer"
          >
            <Slide triggerOnce duration={500} direction="left">
              <Tilt
                scale={1.2}
              ...
              >
                ...
                <div className="card-text p-6">
                  ...
                  <Slide triggerOnce duration={800} direction="left">
                    <div id="title3" className="sm:pr-60 flex justify-center">
                      <p className="sm:pr-40 flex justify-center text-white text-2xl font-bold dark:text-white">
                        Spotify Clone
                      </p>
                      <div
                        id="line"
                        className="bg-gray-100 h-1 absolute mt-10 transition-all ease-in duration-1000 translate w-40"
                      ></div>
                    </div>
                  </Slide>
                  <p
          ...
          <div
            onClick={() => click(5)}
            className="sm:row-span-1 card-text container max-w-sm pt-10 mx-auto cursor-pointer"
          >
            <Slide triggerOnce duration={500} direction="right">
              <Tilt
                scale={1.2}
                ...
                <div className="card-text p-6">
                  <Slide triggerOnce duration={800} direction="right">
                    <div id="title1" className="sm:pr-60 flex justify-center">
                      ...
                      <div
                        id="line"
                        className="sm:w-36 bg-gray-100 absolute ml-24 mt-36 mr-80 h-1  transition-all ease-in duration-1000 right-4 translate w-0"
                      ></div>
                    </div>
                  </Slide>
                  <p
            ...
            <Slide triggerOnce duration={500} direction="right">
              ...
              >
                ...
                <div className="card-text p-6">
                  ...
                  ></div>
                  <Slide triggerOnce duration={800} direction="right">
                    <div id="title1" className="sm:pr-64 flex justify-center">
                      <p className="sm:pr-64 flex justify-center text-white text-2xl font-bold dark:text-white">
                        GBSHSE Website Admin Panel
                      </p>
                    </div>
                ...
                <div className="card-text p-6">
                  ...
                  >
                    <div id="title3" className="sm:pr-60 flex justify-center">
                      ...
                      <div
                        id="line"
                        className="bg-gray-100 mt-10 h-1 absolute  transition-all ease-in duration-1000 translate w-40"
                      ></div>
                    </div>
                  </Slide>
                  <p
